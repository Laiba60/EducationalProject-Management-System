...
const activities = [
  {
    ...
    text: (
      <>
        <span className="font-semibold">Dr. Aris Thorne</span> uploaded a new project proposal:{" "}
        <span className="text-[#b8860b] font-medium italic">"Quantum Cryptography in IoT"</span>
      </>
    ),
    time: "3 MINUTES AGO",
  },
  {
    ...
    text: (
      <>
        <span className="font-semibold">System Audit</span> completed successfully for department{" "}
  ...
  },
  {
    ...
    text: (
      <>
        <span className="font-semibold">Quota Alert:</span> Teacher{" "}
        <span className="font-semibold">Prof. Sarah Jenkins</span> has reached the maximum project limit.
      </>
    ),
    time: "1 HOUR AGO",
  },
  {
    ...
    text: (
      <>
        <span className="font-semibold">12 Students</span> were bulk imported via CSV successfully.
      </>
    ),
    time: "2 HOURS AGO",
  },
